...
local function setAttackVars(attackVars, doShove)
    ...
    setAttackVarBoolean(attackVars, "isBareHeadsWeapon", doShove)
end
...
local function isHandWeapon(item)
    ...
    return safeCall("instanceof.HandWeapon", function()
